...
const LoginScreen =()=>{
    return(
        <View style={{flex:1, backgroundColor:"black", padding:30}}>
            ...
            <Text style={{color:"white", fontSize:45, fontWeight:"bold"}}>Listen to all the podcasts you want on your phone.</Text>
            </View>

            <TouchableOpacity style={{width:320, height:55, borderRadius:30, backgroundColor:"#6C7AFE", display:"flex", justifyContent:"center", alignItems:"center", marginTop:30}}>
                <Text style={{color:"white", fontSize:20, fontWeight:"bold"}}>Sign in</Text>
            </TouchableOpacity>

            <TouchableOpacity style={{width:320, height:55, borderRadius:30, backgroundColor:"black", display:"flex", justifyContent:"center", alignItems:"center", marginTop:20, borderColor:"white", borderWidth:1.5}}>
