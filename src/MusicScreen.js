...
const MusicScreen =()=>{
    return(
        ...
        <View style={{flex:1, backgroundColor:"black", padding:30}}>
            ...
            <View style={{justifyContent:"center", alignItems:"center", paddingTop:25, flexDirection:"row"}}>
             <Feather
            name="skip-back"
            size={24}
            color="white"
            ...
            <View style={{backgroundColor:"#161616", marginTop:50, height:150, borderTopLeftRadius:20, borderTopRightRadius:20, padding:20}}>
                <Text style={{color:"white", fontSize:25, fontWeight:"bold"}}>Downloads</Text>
                <View style={{flexDirection:"row", paddingTop:20}}>
                <View>
                <Image source={require('../assets/images.jpeg')} style={{width:70, height:70, borderRadius:10, paddingTop:20}}/>
                </View>
